...
- **Versioning:** consumers use the `main` raw URL for now (churn tolerated pre-1.0 of the config surface). Once the surface stabilizes, cut tagged releases and consumers pin those instead.
